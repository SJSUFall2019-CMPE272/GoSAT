    ...
    <Col lg="12">
      ...
      <Row className="row-grid justify-content-center align-items-center">
        <Col className = "px-2 py-2" lg="3">
          <Card id="changethislinkkunj" className="card-coin card-plain text-center">
            <CardBody>
              <div className="info">
                <div className="icon icon-danger">
                  <i className="fas fa-medal" />
                </div>
                <h4 className="title info-title">Mention your Achievements</h4>
        ...
        <Col className = "px-2 py-2" lg="3">
          <Card className="card-coin card-plain text-center">
            <CardBody>
              <div className="info">
                <div className="icon icon-danger">
                  <i className="fas fa-chart-line" />
                </div>
                <h4 className="title info-title">We provide insights</h4>
                <hr className="line-danger" />
                <p>
          ...
          <Card className="card-coin card-plain text-center">
            <CardBody>
              <div className="info">
                ...
                <h4 className="title info-title">Your dream graduation</h4>
                <hr className="line-danger" />
                <p>
