...
class Dashboard extends React.Component {
  ...
  render(){
    ...
    let sat = profileDetails && profileDetails.sat.readingWritingScore 
                + profileDetails.sat.essayScore
                  + profileDetails.sat.mathScore;
    let act = profileDetails && profileDetails.act.compositeScore
                + profileDetails.act.elaScore;
    return (
<>
  <MyNavbar />
