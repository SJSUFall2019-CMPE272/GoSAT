                        ...
                        <CardBody>
                            ...
                            <AvForm onInvalidSubmit={this.handleInvalidSubmit} onValidSubmit={this.signUp}>
                                ...
                                <AvRadioGroup inline name="transfer" label="Transfer Student" required>
                                    <AvRadio label="True" value="true" name="True" id="true" onChange={this.changeRadioHandlerAct} />
                                    <AvRadio label="False" value="false" name="False" id="false" onChange={this.changeRadioHandlerAct} />
                                </AvRadioGroup>
                                <FormGroup>
                                    <fieldset>
