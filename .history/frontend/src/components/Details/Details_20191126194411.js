    ...
    render() {
        ...
        if (this.state.sat == "appeared") {
            satDetails =
                (<div>
                    <FormGroup>
                        <AvField className = "input-group"  type="number" name="readingWritingScore" min={500} max={800} label="Reading Writing Score:" id="readingWritingScore" onChange={this.changeHandler} placeholder="" required />
                    ...
                    <Card>
                        <CardBody>
                            ...
                            <AvForm onInvalidSubmit={this.handleInvalidSubmit} onValidSubmit={this.signUp}>
                                ...
                                <FormGroup>
                                    <AvField type="number" step="any" name="gpa" label="Current GPA:" id="gpa" onChange={this.changeHandler} placeholder="" required />
                                </FormGroup>
