...
class Details extends React.Component{
    ...
    render(){
        ...
        if(this.state.act == "appeared"){
            ...
            (<div>
                <FormGroup>
                    <AvField type="number" name="compositeScore" label="Composite Score:" id="compositeScore" onChange={this.changeHandler} placeholder="" required />
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="inputGroupPrepend">/36</span>
                    </div>
                </FormGroup>
                <FormGroup>
                    <AvField type="number" name="writingScore" label="Writing Score:" id="writingScore" onChange={this.changeHandler} placeholder="" required />
                    <div class="input-group-prepend">
