...
class Details extends React.Component{
    ...
    satDetails = () => {
        if(this.state.sat == "Appeared"){
            return <div class="collapse" id="collapseExample">
                <FormGroup>
                    ...
                    <Card>
                        ...
                        <AvForm onInvalidSubmit={this.handleInvalidSubmit} onValidSubmit={this.signUp}>
                            ...
                            <AvRadioGroup inline name="sat" label="SAT" required>
                                <AvRadio label="Appeared" data-toggle="collapse" data-target="#collapseExample" value="appeared" name="Appeared" id="appeared" onChange={this.changeRadioHandlerSat} />
