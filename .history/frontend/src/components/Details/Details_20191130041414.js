            ...
            satDetails =
                (
                  <div>
                    ...
                    <FormGroup>
                        <AvField type="number" name="agc" min={200} max={800} label="A-G Requirement Courses Score:" id="subject2Score" onChange={this.changeHandler} placeholder="" required />
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroupPrepend">/800</span>
                        </div>
                    </FormGroup>
        ...
        if (this.state.actStatus == "appeared") {
            actDetails =
                (<div>
                    ...
                    <FormGroup>
                        <AvField type="number" name="actE" min={12} max={36} label="English Literature and Arts Score:" id="elaScore" onChange={this.changeHandler} placeholder="" required />
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroupPrepend">/36</span>
                        </div>
                    </FormGroup>
